          ...
          <div style="padding: 32px;">
            <table style="width: 100%; border-collapse: collapse;">
              ...
              ${phone ? `<tr>
                ...
                <td style="padding: 12px 0; border-bottom: 1px solid rgba(255,255,255,0.1); font-size: 15px;"><a href="tel:${phone}" style="color: #a78bfa;">${phone}</a></td>
              </tr>` : ''}
              ${company ? `<tr>
                ...
                <td style="padding: 12px 0; border-bottom: 1px solid rgba(255,255,255,0.1); font-size: 15px;">${company}</td>
              </tr>` : ''}
              ${service ? `<tr>
                ...
                <td style="padding: 12px 0; border-bottom: 1px solid rgba(255,255,255,0.1); font-size: 15px;">${service}</td>
              </tr>` : ''}
              <tr>
            ...
            <div style="margin-top: 24px; padding-top: 24px; border-top: 1px solid rgba(255,255,255,0.1); text-align: center;">
              <a href="mailto:${email}" style="display: inline-block; padding: 12px 32px; background: linear-gradient(135deg, #9d174d, #4c1d95); color: #fff; text-decoration: none; border-radius: 8px; font-size: 14px; font-weight: 500;">Reply to ${name}</a>
            </div>
          </div>
        </div>
      `,
