...
export default function ServicesContent() {
  ...
  return (
    <>
      <HeroSection
        tag="What We Do"
        heading={<>Our <span className="font-serif italic gradient-text">Services</span></>}
        subtext="Everything your business needs to dominate online — under one roof. From first impression to final conversion, we've got you covered."
      />
      ...
      <CTASection
        heading={<>Ready to Get <span className="font-serif italic gradient-text">Started?</span></>}
        subtext="Tell us about your project and we'll send you a custom proposal within 48 hours."
