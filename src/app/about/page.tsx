...
const values = [
  { title: 'Craft Over Convention', desc: 'We don\'t use templates. Every project is designed from scratch to reflect your unique brand and goals.' },
  { title: 'Transparency Always', desc: 'No jargon, no hidden costs, no surprises. You\'ll know exactly what\'s happening at every stage.' },
  { title: 'Results That Compound', desc: 'We build assets, not expenses. Your website should generate more value every month it\'s live.' },
  { title: 'Partnership, Not Vendor', desc: 'We invest in your success long-term. When you grow, we grow — that\'s the relationship we want.' },
];
    ...
    <>
      ...
      <section className="relative pt-40 pb-20 px-6 mesh-bg noise overflow-hidden">
        <div className="max-w-7xl mx-auto relative z-10">
          <SectionReveal>
            <p className="text-sm uppercase tracking-widest text-accent-purple mb-4">About Us</p>
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-medium leading-[0.95] tracking-tight mb-8">
              The Team Behind
              <br />
              Your <span className="font-serif italic gradient-text">Digital Success</span>
            </h1>
            <p className="text-lg md:text-xl text-muted max-w-2xl leading-relaxed">
              We&apos;re Oceanview Web Co — a premium web design and digital marketing agency rooted in Virginia Beach, VA. We build digital experiences that grow businesses.
            </p>
          </SectionReveal>
        </div>
      </section>
      ...
      <section className="py-32 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <SectionReveal>
              <p className="text-sm uppercase tracking-widest text-accent-purple mb-4">Our Story</p>
              <h2 className="text-4xl md:text-5xl font-medium leading-tight mb-8">
                From Allen Larson Creative
                <br />
                to <span className="gradient-text">Oceanview Web Co</span>
              </h2>
              <div className="space-y-6 text-muted leading-relaxed">
                <p>
                  What started as a one-person freelance operation has evolved into a full-service digital agency. Allen Larson Creative was born out of a passion for helping small businesses compete online — designing websites, crafting brands, and driving real results through digital marketing.
                </p>
                <p>
                  As the client roster grew and the work deepened, it became clear that the brand needed to evolve too. Oceanview Web Co represents everything we&apos;ve become: a team-driven agency with a broader vision, deeper capabilities, and the same relentless commitment to quality that started it all.
                </p>
                <p>
                  The name pays homage to our home in Virginia Beach — where the ocean meets opportunity. We bring that coastal clarity to everything we build: clean design, open communication, and the kind of craftsmanship that stands the test of time.
                </p>
              </div>
            </SectionReveal>
            ...
            <SectionReveal delay={0.2} direction="right">
              <div className="relative">
                ...
                <div className="aspect-square rounded-2xl bg-card border border-card-border overflow-hidden relative">
                  <div className="absolute inset-0 mesh-bg" />
                  <svg className="absolute inset-0 w-full h-full opacity-10" viewBox="0 0 400 400">
                    {Array.from({ length: 30 }).map((_, i) => (
                      <circle
                        key={i}
                        cx={200 + Math.cos(i * 0.5) * (i * 4)}
                        cy={200 + Math.sin(i * 0.5) * (i * 4)}
                        r={3 + i * 0.5}
                        fill="none"
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <span className="text-8xl font-medium gradient-text opacity-20">OV</span>
                  </div>
                </div>
              </div>
            </SectionReveal>
      ...
      <section className="py-32 px-6">
        <div className="max-w-7xl mx-auto">
          <SectionReveal>
            <p className="text-sm uppercase tracking-widest text-accent-purple mb-4 text-center">What We Believe</p>
            <h2 className="text-4xl md:text-5xl font-medium text-center mb-20">
              Our <span className="font-serif italic gradient-text">Values</span>
            </h2>
          </SectionReveal>
            ...
            {values.map((value, i) => (
              <SectionReveal key={value.title} delay={i * 0.1}>
                <div className="bg-card border border-card-border rounded-2xl p-8 hover:border-accent-purple/30 transition-all duration-500">
                  ...
                  <h3 className="text-xl font-medium mt-3 mb-3">{value.title}</h3>
      ...
      <section className="py-32 px-6">
        <div className="max-w-7xl mx-auto">
          <SectionReveal>
            <p className="text-sm uppercase tracking-widest text-accent-purple mb-4 text-center">Who We Serve</p>
            <h2 className="text-4xl md:text-5xl font-medium text-center mb-6">
              Industries We <span className="font-serif italic gradient-text">Specialize</span> In
            </h2>
            <p className="text-muted text-center max-w-xl mx-auto mb-20">
              While we work with businesses of all kinds, these are the industries where we have the deepest expertise and the strongest track record.
            </p>
          </SectionReveal>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <SectionReveal>
            ...
            <p className="text-muted text-lg mb-10 max-w-xl mx-auto">
              Ready to work with a team that treats your business like their own? Let&apos;s talk.
            </p>
            <button
